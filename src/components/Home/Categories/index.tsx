            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <Card className="group cursor-pointer hover:scale-[1.02] transition-all duration-300 shadow-lg hover:shadow-xl border-1 border-gray-100 dark:border-gray-800">
                <CardBody className="p-0 relative overflow-hidden">
                  ...
                  <div className="p-6">
                    <h3 className="text-xl font-bold text-dark dark:text-white mb-2 flex items-center gap-2">
                      <Icon icon="mdi:pot-steam" className="text-primary" />
                      Traditional Curries
                    </h3>
                    <p className="text-dark/70 dark:text-white/70 text-sm leading-relaxed">
                      Rich and flavorful curries like karahi, nihari, and dal,
                      slow-cooked with authentic spices.
                    </p>
                  </div>
                </CardBody>
              </Card>
              ...
              <Card className="group cursor-pointer hover:scale-[1.02] transition-all duration-300 shadow-lg hover:shadow-xl border-1 border-gray-100 dark:border-gray-800">
                <CardBody className="p-0 relative overflow-hidden">
                  ...
                  <div className="p-6">
                    <h3 className="text-xl font-bold text-dark dark:text-white mb-2 flex items-center gap-2">
                      <Icon icon="mdi:cake-variant" className="text-primary" />
                      Sweets & Desserts
                    </h3>
                    <p className="text-dark/70 dark:text-white/70 text-sm leading-relaxed">
                      Indulge in traditional mithai, kulfi, and other sweet
                      treats that end every meal perfectly.
                    </p>
                  </div>
                </CardBody>
              </Card>
